...
#align(center)[
  ...
  Student: Nicolás Carranza (220005595) \
...
What made the results particularly interesting was analysing the emergent communication protocols across 10,000 samples. The agents showed remarkable vocabulary efficiency, actively using only about 7 out of 50 available symbols. Some patterns that emerged where that some digits consistently received alternating symbol sequences like [31, 13, 31, 13, ...], whilst others triggered repeating patterns such as [37, 37, 37, ...]. Interestingly, symbol 31 appeared as a prefix across multiple digit patterns, suggesting emergent compositional structure.
